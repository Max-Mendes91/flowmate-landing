                ...
                <div className="text-center">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-1 gap-2 sm:space-y-0">
                    ...
                    <button
                      ...
                      className="w-full px-3 sm:px-6 py-2 sm:py-3 rounded-lg sm:rounded-xl bg-white/5 border border-white/10 text-text-secondary text-xs sm:text-base font-medium hover:bg-white/10 hover:text-text-primary transition-all flex items-center justify-center gap-1.5 sm:gap-2"
                    >
                      <svg
